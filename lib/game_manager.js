...
function GameManager(size,startTiles,gamestateJson ) {

    //Initialize game state
    this.setup(size,startTiles,gamestateJson);
}
...
// Set up the game
GameManager.prototype.setup = function (size,startTiles,gamestateJson) {
  ...
  if(gamestateJson == null) {
      ...
      var gameObj = JSON.parse(gamestateJson);
      this.size        = gameObj['size']; // Size of the grid
      this.startTiles   = gameObj['startTiles'];
      this.grid        = new Grid(this.size,gameObj['grid']);
      this.score       = gameObj['score'];
      this.over        = gameObj['over'];
      this.won         = gameObj['won'];
  }
